...
namespace HK.Formas
{
    public partial class FrmTablas_Proveedores : Form
    {
        ...
        void FrmProveedors_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Insert:
        ...
        void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            f.Tablas_Proveedores((Tercero[])bs.DataSource);
            f = null;
        }
        ...
        {
            this.bs.DataSource = data.GetAllProveedores(this.txtBuscar.Text);
        ...
        private void AgregarRegistro()
        {
            do
            {
                FrmTablas_ProveedoresItem F = new FrmTablas_ProveedoresItem()
                { data = this.data };
                F.Incluir();
        ...
        private void EliminarRegistro()
        {
            if (this.gridView1.IsFocusedView)
            {
                ...
                data.EliminarProveedor((Tercero)this.bs.Current,true); 
                Busqueda();
            }
        }
