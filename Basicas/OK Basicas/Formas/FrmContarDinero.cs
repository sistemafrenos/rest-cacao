...
namespace HK.Formas
{
    public partial class FrmContarDinero : Form
    {
        ...
        {
            InitializeComponent();
            this.Load += new EventHandler(FrmContarDinero_Load);
        }

        void FrmContarDinero_Load(object sender, EventArgs e)
        {
            this.KeyPreview = true;
            this.KeyDown += new KeyEventHandler(FrmLapso_KeyDown);
            this.btnImprimirFisca.Click += new EventHandler(btnImprimirFisca_Click);
        ...
        void btnImprimirFisca_Click(object sender, EventArgs e)
        {
            cargarReporte();
        ...
        {
            reporte.Clear();
            reporte.Add("CONTADOR DE DINERO");
            reporte.Add("==================");
            reporte.Add(string.Format("{0} x {1}  = {2}", s500.Value.ToString("N2").PadLeft(10), "500", ((decimal)txt500.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s100.Value.ToString("N2").PadLeft(10), "100", ((decimal)txt100.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s50.Value.ToString("N2").PadLeft(10), " 50", ((decimal)txt50.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s20.Value.ToString("N2").PadLeft(10), " 20", ((decimal)txt20.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s10.Value.ToString("N2").PadLeft(10), " 10", ((decimal)txt10.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s5.Value.ToString("N2").PadLeft(10), "  5", ((decimal)txt5.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s2.Value.ToString("N2").PadLeft(10), "  2", ((decimal)txt2.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add(string.Format("{0} x {1}  = {2}", s1.Value.ToString("N2").PadLeft(10), "  1", ((decimal)txt1.EditValue).ToString("N2").PadLeft(10)));
            reporte.Add("");
            reporte.Add(string.Format("TOTAL CONTADO:{0}", ((decimal)(txtTotal.EditValue)).ToString("N2").PadLeft(10)));
            reporte.Add("");
            reporte.Add("");
        }
