    ...
    namespace Utilitatios
    {
        public sealed class Numalet
        {
            ...
            public Int32 Decimales
            {
                ...
                {
                    if (value > 10)
                        throw new ArgumentException(value + " excede el número máximo de decimales admitidos, solo se admiten hasta 10.");
                    _decimales = value;
                }
            }
            ...
            public String MascaraSalidaDecimal
            {
                ...
                set
                {
                    ...
                    if (_esMascaraNumerica)
                        _mascaraSalidaDecimalInterna = String.Format("{0}'{1}'", value.Substring(0, _posiciones), value.Substring(_posiciones)
            ...
            public String ToCustomCardinal(String Numero)
            {
                ...
                if (Double.TryParse(Numero, NumberStyles.Float, _cultureInfo, out dNumero))
                    ...
                    throw new ArgumentException(String.Format("'{0}' no es un número válido.", Numero));
            }
            ...
            {
                Int64 Num = (Int64)Math.Abs(Numero);
                Int32 terna;
                Int32 centenaTerna;
                Int32 decenaTerna;
                Int32 unidadTerna;
                ...
                if (Num >= 1000000000000 || Num < 0)
                    throw new ArgumentException(String.Format("El número '{0}' excedió los límites del conversor: [0;1.000.000.000.000)", Numero));
                if (Num == 0)
                ...
                else
                {
                    ...
                    while (Num > 0)
                    {
                        ...
                        if ((decenaTerna > 0) && (decenaTerna < 10))
                            ...
                            if ((decenaTerna >= 10) && (decenaTerna < 20))
                                cadTerna = cadTerna + _matriz[DIECI, unidadTerna];
                            else
                                if (decenaTerna == 20)
                                    cadTerna = cadTerna + " veinte";
                                else
                                    if ((decenaTerna > 20) && (decenaTerna < 30))
                                        cadTerna = " veinti" + _matriz[UNI, unidadTerna].Substring(1);
                                    else
                                        if ((decenaTerna >= 30) && (decenaTerna < 100))
                                            if (unidadTerna != 0)
                                                cadTerna = String.Format("{0} y{1}{2}", _matriz[DECENA, (Int32)(decenaTerna / 10)], _matriz[UNI, unidadTerna], cadTerna);
                                            else
                        ...
                        switch (centenaTerna)
                        {
                            ...
                            default:
                                if ((Int32)(terna / 100) > 1)
                                    cadTerna = String.Format("{0}cientos{1}", _matriz[UNI, (Int32)(terna / 100)], cadTerna);
                                break;
                        }
                        ...
                        if ((iTerna > 1 | ApocoparUnoParteEntera) && decenaTerna == 21)
                            ...
                            if ((iTerna > 1 | ApocoparUnoParteEntera) && unidadTerna == 1 && decenaTerna != 11)
                ...
                if (Decimales > 0)
                {
                    Resultado.Append(String.Format(" {0} ", SeparadorDecimalSalida));
                    ...
                    if (ConvertirDecimales)
                    {
                        ...
                        Resultado.Append(String.Format("{0} {1}", Convertir((Decimal)EnteroDecimal, 0, null, null, EsMascaraNumerica, false, false, (ApocoparUnoParteDecimal && !EsMascaraNumerica /*&& !esMascaraDecimalDefault*/), false), (EsMascaraNumerica ? "" : MascaraSalidaDecimal)));
                    }
                    else
                        if (EsMascaraNumerica)
                            Resultado.Append(EnteroDecimal.ToString(MascaraSalidaDecimal));
                        else
                            Resultado.Append(String.Format("{0} {1}", EnteroDecimal, MascaraSalidaDecimal));
                }
