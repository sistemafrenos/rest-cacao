...
namespace HK.Formas
{
    public partial class FrmTablas_Insumos : Form
    {
        Restaurant data;
        public FrmTablas_Insumos()
        {
            InitializeComponent();
            if (data == null)
                data = new Restaurant();
            this.Load += new EventHandler(FrmProductos_Load);
            BarraAcciones.Text = "Insumos";
        ...
        //void btnEtiquetas_Click(object sender, EventArgs e)
        //{
        //    FrmTags f = new FrmTags();
        //    f.ShowDialog();
        //}

        void btnInsumosIngredientes_Click(object sender, EventArgs e)
        {
        ...
        void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            f.Restaurant_Insumos(data.GetAllInsumos(txtBuscar.Text, null));
            f = null;
        }
        ...
        {
            this.bs.DataSource = data.GetAllProductosSoloCompras(txtBuscar.Text);
        ...
        private void AgregarRegistro()
        {
            do
            {
                using (var F = new FrmTablas_InsumosItem())
                {
                    F.Incluir(null);
        ...
        private void CopiarRegistro()
        {
            if (this.bs.Current == null)
                return;
            FrmTablas_InsumosItem F = new FrmTablas_InsumosItem();
