...
namespace HK.Formas
{
    ...
    public partial class FrmRestaurant_CotizacionesItem : Form
    {
        public string IdCotizacion { set; get; }
        public Restaurant data;
        public Cotizacion cotizacion;
        public FrmRestaurant_CotizacionesItem()
        {
            InitializeComponent();
            KeyPreview = true;
            if (data == null)
        ...
        void FrmCotizacionesItem_Load(object sender, EventArgs e)
        {
            ...
            #endregion 
            #region Eventos
            UbicacionComboBoxEdit.Properties.Items.AddRange(data.GetUbicaciones());
        ...
        void CargarDoc_Click(object sender, EventArgs e)
        {
            ...
            if (f.DialogResult != System.Windows.Forms.DialogResult.OK)
                return;
            cotizacion = (Cotizacion)data.CloneDocumento((Documento)f.registro);
            Enlazar();
        }
        void Imprimir_Click(object sender, EventArgs e)
        {
            ...
            {
                f.Restaurant_Cotizacion((Cotizacion)cotizacion, false);
            }
        ...
        void Email_Click(object sender, EventArgs e)
        {
            ...
            f.Restaurant_Cotizacion((Cotizacion)cotizacion, true);
            DialogResult = System.Windows.Forms.DialogResult.OK;
            Close();
        }
        ...
        void btnAgregar_Click(object sender, EventArgs e)
        {
            do
            {
                FrmVentasItemEdicion f = new FrmVentasItemEdicion() { data = data, tipoPrecio = cotizacion.TipoPrecio };
                f.Incluir();
                if (f.DialogResult != System.Windows.Forms.DialogResult.OK)
                {
                    return;
